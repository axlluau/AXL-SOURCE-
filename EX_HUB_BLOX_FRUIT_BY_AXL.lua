...
local Update = (loadstring(Game:HttpGet("https://raw.githubusercontent.com/RTaOexe1/rtao_dev/refs/heads/main/RO_UI_1.lua")))();
...
local MainTab = Library:Tab("رئيسي", "rbxassetid://10723407389");
local FarmTab = Library:Tab("فارم", "rbxassetid://10723415335");
local ItemsTab = Library:Tab("اغراض", "rbxassetid://10709782497");
local SettingsTab = Library:Tab("اعدادات", "rbxassetid://10734950309");
local LocalPlayerTab = Library:Tab("لاعبين", "rbxassetid://10747373176");
local HoldTab = Library:Tab("مهارة الاحتفاظ", "rbxassetid://10734984606");
if World3 then
	SeaTab = Library:Tab("ايفنت البحر", "rbxassetid://10709761530");
	SettingSeaTab = Library:Tab("اعدادات البحر", "rbxassetid://10709810948");
end;
if World2 or World3 then
	SeaStackTab = Library:Tab(" كومة البحر", "rbxassetid://10747376931");
end;
if World3 then
	CraftTab = Library:Tab("الكرافت", "rbxassetid://10723405360");
	DragonDojoTab = Library:Tab("دراغون دوجو", "rbxassetid://10734951847");
end;
local StatsTab = Library:Tab("ستاتس", "rbxassetid://10709770317");
if World3 or World2 then
	RaceV4Tab = Library:Tab("ريس V4", "rbxassetid://10723425539");
end;
local CombatTab = Library:Tab("اساليب ", "rbxassetid://10734975486");
if World2 or World3 then
	RaidTab = Library:Tab("رايدات", "rbxassetid://10723345749");
end;
local EspTab = Library:Tab("كشف", "rbxassetid://10723346959");
local TeleportTab = Library:Tab("تنقل", "rbxassetid://10734886004");
local ShopTab = Library:Tab("متجر", "rbxassetid://10734952479");
local FruitTab = Library:Tab("فواكهة شيطان", "rbxassetid://10734883986");
local MiscTab = Library:Tab("اشياء اخرى", "rbxassetid://10723424838");
local ServTab = Library:Tab("سيرفر", "rbxassetid://10723426722");
_G.Settings = {
	Main = {
		["اختر السلاح"] = "Melee",
		["وضع الفارم"] = "Normal",
		["فارم تلقائي"] = false,
		["فارم تلقائي سريع"] = false,
		["وضع اختيار ماستري"] = "Quest",
		["تفريم ماستري فاكهة"] = false,
		["تفريم الاسلحه"] = false,
		["اختيار ماستري السيوف"] = nil,
		["فارم ماستري سيوف"] = false,
		["اختيار الموب"] = nil,
		["فارم الموب"] = false,
		["اختيار البوص"] = nil,
		["فارم البوص"] = false,
		["تفريم جميع البوص"] = false
	},
	Event = {},
	Farm = {
		["فارم الهنتر"] = false,
		["فارم الهنتر في سيرفر خاص"] = false,
		["حدد وضع فارم العضام"] = "Quest",
		["فارم العضام"] = false,
		["مفاجأة عشوائية تلقائية"] = false,
		["تفريم رايد قراصنه"] = false,
		["فارم هاكي تنبئ"] = false,
		["فارم هاكي تنبئ v2"] = false,
		["قبعة الفارس الآلي"] = false,
		["سيف شانكس"] = false,
		["فارم صندوق v1 "] = false,
		["فارم صندوق v2"] = false,
		["فارم صندوق سيرفر خاص"] = false,
		["فارم صندوق ميراج"] = false,
		["إيقاف العناصر تلقائيًا"] = false,
		["فارم كاتاكوري"] = false,
		["رسبنه كاتاكوري"] = false,
		["فارم لقتل كاتاكوري"] = false,
		["فارم كاتاكوري v2"] = false,
		["فارم اشعاع   Radioactive"] = false,
		["فارم قطره غامضة Mystic Droplet"] = false,
		["فارم حمم صهارة Magma Ore "] = false,
		["فارم جناح انجل Angel Wings"] = false,
		["فارم الجلد Leather"] = false,
		["فارم خردة المعادن Scrap Metal"] = false,
		["فارم الككاو"] = false,
		["فارم حراشف تنين Dragon Scale"] = false,
		["فارم البارود Gunpowder"] = false,
		["فارم ذيل السمكة Fish Tail"] = false,
		["فارم ناب صغير "] = false
	},
	Setting = {
		["وضع الدوران"] = false,
		...
		["سرعه لاعب"] = 350,
		["جلب موبات"] = true,
		["اختيار جلب الموبات"] = "Normal",
		["ضرب سريع"] = true,
		["اختيار ضرب سريع"] = "Normal",
		["نوع الضرب"] = "New",
		["هالة الهجوم"] = true,
		["إخفاء الإشعار"] = false,
		["إخفاء نص الضرر"] = true,
		...
		["اخفاء الموبات"] = false,
		["ماستري دم موبات"] = 25,
		["مهارة إتقان الفاكهة Z"] = true,
		["مهارة إتقان الفاكهة X"] = true,
		["مهارة إتقان الفاكهة C"] = true,
		["مهارة إتقان الفاكهة V"] = false,
		["مهارة إتقان الفاكهة F"] = false,
		["مهارة إتقان السلاح Z"] = true,
		["مهارة إتقان السلاح X"] = true,
		["تحديد نقطة الظهور التلقائي"] = true,
		["تفعيل هاكي تنبئ"] = false,
		["تفعيل هاكي تصلب"] = true,
		["إعادة الانضمام التلقائي"] = true,
		["تجاوز نظام مكافحة الغش"] = true
	},
	Hold = {
		["إتقان مهارة Z"] = 0,
		["إتقان المهارة X"] = 0,
		...
		["إتقان المهارة V"] = 0,
		["إتقان المهارة F"] = 0,
		["مهارة الإمساك بالبحر Z"] = 0,
		["مهارة الإمساك بالبحر X"] = 0,
		["مهارة الحفاظ على البحر C"] = 0,
		["مهارة الثبات البحري V"] = 0,
		["مهارة هولد F"] = 0
	},
	Stats = {
		["ستاتس للاسلوب"] = false,
		["ستاتس دفاع و شفاء"] = false,
		["ستاتس فاكهة"] = false,
		["ستاتس سيوف"] = false,
		["ستاتس اسلحه"] = false,
		["اختيار رقم ستاتس"] = 1
	...
	Items = {
		["فارم مهمه عالم ثاني"] = false,
		["فارم مهمه عالم ثالث"] = false,
		["فارم مصنع"] = false,
		["فارم سوبر هيومنv1"] = false,
		["فارم اسلوب سانجي v2"] = false,
		["فارم اسلوب ماءv2"] = false,
		["فارم اسلوب كهرباء"] = false,
		["فارم اسلوب تنين"] = false,
		["فارم اسلوب سوبر هيومنv2"] = false,
		["فارم سيف بيق مام"] = false,
		["فارم كيتار بروك"] = false,
		["فارم سيف رينغوكو"] = false,
		["فارم سيف منجل"] = false,
		["فارم سيف واردن"] = false,
		["فارم سيوف اودن"] = false,
		["فارم ياما"] = false,
		["فارم توشيتا"] = false,
		["فارم كافندر"] = false,
		["فارم رمح التنين"] = false,
		["فارم سيف اينيل"] = false,
		["فارم سيف قرش عالم اول"] = false,
		["فارم سيف عمو لحية بيضاء"] = false,
		["فارم نضارات فلامينغو"] = false,
		["دمية التدريب"] = false,
		["فارم سيف ميهوك الصغير"] = false,
		["فارم ضغط على زر هاكي"] = false,
		["فارم هاكي تصلب الملون"] = false,
		["فارم شعله سيف تويتا"] = false,
		["فارم مهمه بارتولميو"] = false
	},
	Esp = {
		["كشف لاعبين"] = false,
		["كشف صناديق"] = false,
		["كشف فواكه"] = false,
		["كشف فواكه v2 حقيقي"] = false,
		["كشف الورد"] = false,
		["كشف جميع الجزر"] = false,
		["كشف الموبات"] = false,
		["كشف وحش بحر"] = false,
		["كشف وحش"] = false,
		["كشف ميراج"] = false,
		["كشف جزيرة كيتسوني"] = false,
		["كشف مكان الهايدرا"] = false,
		["كشف بائع فواكه ميراج"] = false,
		["كشف الهالة"] = false,
		["كشف الترس"] = false
	},
	DragonDojo = {
		["كشف شعلات تنين"] = false,
		["تجميع شعلات تنين"] = false
	},
	SeaEvent = {
		["اختيار قارب"] = "Guardian",
		["اختيار زون البحر"] = "Zone 5",
		["اختيار سرعه القارب"] = 300,
		["شراع القارب"] = false,
		["فارم قرش"] = true,
		["فارم البيرانا"] = true,
		["فارم اعضاء الاسماك"] = true,
		["فارم سفن المهجورة"] = true,
		["فارم سفن قراصنه"] = true,
		["فارم سفن قراصنه اكثر"] = true,
		["فارم قرش المرساة"] = true,
		["فارم وحوش بحر"] = true,
		["مراوغة هجوم وحوش بحر"] = true,
		["مرواوغة هجوم قرش مرساة"] = true,
		Lightning = false,
		["زيادة سرعة قارب"] = false,
		["اختراق الصخور"] = false
	},
	SettingSea = {
		["Skill فاكهة"] = true,
		...
		["Skill سيف"] = true,
		["Skill اسلحه"] = true,
		["Sea فاكهة Skill Z"] = true,
		["Sea فاكهة Skill X"] = true,
		["Sea فاكهة Skill C"] = true,
		["Sea فاكهة Skill V"] = false,
		["Sea فاكهة Skill F"] = false,
		["Sea اسلوب Skill Z"] = true,
		["Sea اسلوب Skill X"] = true,
		["Sea اسلوب Skill C"] = true,
		["Sea اسلوب Skill V"] = true,
		["Sea سيف Skill Z"] = true,
		["Sea سيف Skill X"] = true,
		["Sea اسلحه Skill Z"] = true,
		["Sea اسلحه Skill X"] = true
	},
	SeaStack = {
		["انتقال الى مكان فروزن مال هايدرا"] = false,
		[" شراع لماكن فروزن هايدرا"] = false,
		["فارم رسبنه فروزن هايدرا"] = false,
		["تنقل جزيرة كيتسوني"] = false,
		["تجميع شعلات كيتسوني"] = false,
		["تعيين شعلات كيتسوني"] = 20,
		["تبادل شعلات كيتسوني"] = false,
		["تنقل الى جزيرة ميراج"] = false,
		["تنقل الى بائع فواكه جزيرة ميراج"] = false,
		["هجوم تلقائي على وحش بحر"] = false,
		["رسبنه جزيرة تنين"] = false,
		["تنقل جزيرة تنين"] = false,
		["فارم جزيرة تنين"] = false
	},
	Craft = {
		["صنع سكرول عادية"] = false,
		["صنع سكرول وسط"] = false,
		["صنع سكرول لجندري"] = false,
		["صنع سكرول ميثك"] = false
	},
	Race = {
		["فارم ريسv2"] = false,
		["فارم ريس V3"] = false,
		["المكان المختارV4"] = nil,
		["الانتقال الفوري إلى المكان V4"] = false,
		["شراء Gear للريس"] = false,
		["تنقل الى اعلى نقطه ميراج"] = false,
		["بحث عن الترس"] = false,
		["النضور الى قمر"] = false,
		["فارم مهمات v4 للتخول"] = false,
		["قتل لاعبين بل تريل"] = false,
		["فارم تريل"] = false
	},
	Combat = {
		["فارم قتل لاعب مهمه"] = false,
		["ايم بوت اسلحه"] = false,
		["ايم بوت سكلv1"] = false,
		["ايم بوتv2"] = false,
		["تفعيل pvp"] = false
	...
	Raid = {
		["اختيار فاكه الرايظ"] = nil,
		["دنجن فارم"] = false,
		["شراء سكلات رايد تلقائي"] = false,
		["سعر فاكهة الشيطان "] = 1000000,
		["إلغاء التخزين فاكهة"] = false,
		["رايد لاو"] = false
	},
	Shop = {
		["شراء سيوف زورو"] = false,
		["شراء هاكي ميثك"] = false
	},
	LocalPlayer = {
		[""طاقة لا نهائية"] = false,
		["قدرة لا نهائية"] = true,
		["جيبو لانهائي"] = false,
		["فلاش ستيب لا نهائي"] = false,
		["تفادي بدون فترة انتظار"] = false,
		["تشغيل ريسv3"] = false,
		["تشغيل ريس V4"] = true,
		["المشي على الماء"] = true,
		["اختراق جدران"] = false
	},
	Fruit = {
		["شراء تلقائي لفاكهة عشوائية"] = false,
		["تخزين الفاكهة النادرة"] = "Common - Mythical",
		["تخزين فاكهة تلقائي"] = false,
		["إشعار الفاكهة"] = false,
		["الانتقال الفوري إلى الفاكهة"] = false,
		["تنقل الى فواكهة جديد"] = false
	},
	Misc = {
		["إخفاء المحادثة"] = false,
		["إخفاء لوحة المتصدرين"] = false,
		["وضع التمييز"] = false
	}
};
...
MainTab:Button("EX TELEGRAM ", function()
	setclipboard("https://t.me/mmcmy");
	Update:Notify("نسخ!", 3);
end);
MainTab:Seperator("فارم لفل");
local WeaponList = {
	"اسلوب",
	"سيف",
	"فاكهة"
